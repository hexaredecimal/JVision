 ...
 */
public class TVTerminalWindow extends TScrollableWindow {
	 ...
	 */
	public TVTerminalWindow(final TApplication application, final int x,
	...
	public void onResize(final TResizeEvent resize) {
		if (resize.getType() == TResizeEvent.Type.WIDGET) {
			if (terminal != null) {
				TResizeEvent editSize = new TResizeEvent(resize.getBackend(),
					TResizeEvent.Type.WIDGET, resize.getWidth() - 2,
					resize.getHeight() - 2);
				
				terminal.onResize(editSize);
			}
	 ...
	 * @param override if true, force the title to never change regardless
	 * of the desired title from the running terminal
	 */
